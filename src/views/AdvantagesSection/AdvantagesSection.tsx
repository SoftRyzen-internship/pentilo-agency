...
export const AdvantagesSection: React.FC = () => {
  return (
    <section className="section" id="advantages">
      ...
      text-shadow-text md:mb-6 md:max-w-[486px] xl:mb-[15px] xl:w-full  xl:max-w-fit-content xl:text-left"
        >
          <Parallax offset={35}>
        ...
        xl:max-w-fit-content xl:-translate-x-0 xl:-translate-y-[25px] xl:text-xxxl_small ${css.focusTitle}`}
          >
            {data.title.focus}
          </span>
        </h2>
